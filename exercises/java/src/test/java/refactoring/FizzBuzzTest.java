...
public class FizzBuzzTest {
    ...
    @Test
    public void replaceMultiplesOfThreeWithFizzAndMultiplesOfFiveWithBuzz() throws DecoderException {
        assertThat(new FizzBuzz().doFizzBuzzUpToOneHundred().equals(new String(
                Hex.decodeHex(
